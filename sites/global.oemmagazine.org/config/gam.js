...
config.setAliasAdUnits('default', [
  ...
  { name: 'inline-content-mobile', templateName: 'INLINE-CONTENT-MOBILE', path: 'ppoem_imu_1' },
  { name: 'inline-content-desktop', templateName: 'INLINE-CONTENT-DESKTOP', path: 'ppoem_imu_1' },
