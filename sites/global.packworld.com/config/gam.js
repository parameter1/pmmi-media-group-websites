...
config.setAliasAdUnits('default', [
  ...
  { name: 'inline-content-mobile', templateName: 'INLINE-CONTENT-MOBILE', path: 'pw_leaderboard' },
  { name: 'inline-content-desktop', templateName: 'INLINE-CONTENT-DESKTOP', path: 'pw_leaderboard' },
