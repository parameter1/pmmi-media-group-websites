...
config
  .setAliasAdUnits('default', [
    // { name: 'lb1', templateName: 'LB', path: 'aw_leaderboard' },
    // { name: 'rail1', templateName: 'CONTENT', path: 'aw_imu_1' },
    // { name: 'rail2', templateName: 'CONTENT', path: 'aw_imu_2' },
    // { name: 'load-more', templateName: 'CONTENT', path: 'aw_imu_1' },
