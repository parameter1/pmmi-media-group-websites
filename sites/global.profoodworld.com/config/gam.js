...
config.setAliasAdUnits('default', [
  ...
  { name: 'inline-content-mobile', templateName: 'INLINE-CONTENT-MOBILE', path: 'pfw_leaderboard' },
  { name: 'inline-content-desktop', templateName: 'INLINE-CONTENT-DESKTOP', path: 'pfw_leaderboard' },
